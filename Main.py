...
def main(screen_name, renew_tweet_dump, num_times, seed_word, max_words_per_sentence, print_to_CL):
...
if __name__ == "__main__":
    ...
    main(screen_name = screen_name, renew_tweet_dump = renew_tweet_dump, num_times = num_times, seed_word = seed_word, max_words_per_sentence= max_words_per_sentence, print_to_CL = local_print)
